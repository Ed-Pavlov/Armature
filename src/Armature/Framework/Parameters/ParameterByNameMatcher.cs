...
namespace Armature.Framework.Parameters
{
  public class ParameterByNameMatcher : IUnitMatcher
  {
    ...
    public bool Matches(UnitInfo unitInfo) => unitInfo.Id is ParameterInfo parameterInfo && unitInfo.Token == SpecialToken.InjectValue && parameterInfo.Name == _parameterName;
    ...
    [DebuggerStepThrough]
    public override bool Equals(object obj) => Equals(obj as ParameterByNameMatcher);

    public override int GetHashCode() => _parameterName.GetHashCode();
    #endregion
  }
}