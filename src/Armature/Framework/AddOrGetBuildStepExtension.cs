...
namespace Armature.Framework
{
  public static class AddOrGetBuildStepExtension
  {
    ...
    public static T AddOrGetUnitMatcher<T>(this IUnitSequenceMatcher parent, T unitMatcher) where T : IUnitSequenceMatcher
    {
    ...
    /// </summary>
    /// <returns>Newly the build step which will be contained in the <see cref="parent"/> as a child build step</returns>
    public static T AddOrGetUnitMatcher<T>(this BuildPlansCollection parent, T unitMatcher) where T : IUnitSequenceMatcher
    {
