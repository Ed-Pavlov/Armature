...
public interface ISubjectTuner : ITunerBase
{
  ...
  /// </summary>
  /// <param name="type">The type in the "context" of which all later tunings are applied.</param>
  ...
  /// </summary>
  /// <typeparam name="T">The type in the "context" of which all later tunings are applied.</typeparam>
  /// <param name="tag">See <see cref="UnitId"/>.<see cref="UnitId.Tag"/> for details.</param>
  ...
  /// </summary>
  /// <param name="type">The type, the building of which is tuned up by later calls to the tuner.</param>
  /// <param name="tag">See <see cref="UnitId"/>.<see cref="UnitId.Tag"/> for details.</param>
  ...
  /// </summary>
  /// <typeparam name="T">The type, the building of which is tuned up by later calls to the tuner.</typeparam>
  /// <param name="tag">See <see cref="UnitId"/>.<see cref="UnitId.Tag"/> for details.</param>
  ...
  /// </summary>
  /// <param name="openGenericType">The type, the building of which is tuned up by later calls to the tuner.</param>
  /// <param name="tag">See <see cref="UnitId"/>.<see cref="UnitId.Tag"/> for details.</param>
