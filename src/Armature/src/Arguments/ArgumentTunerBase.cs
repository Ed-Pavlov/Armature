...
/// </summary>
public abstract class ArgumentTunerBase<T> : IInternal<Func<IBuildChainPattern, IBuildChainPattern>>
{
  protected readonly Func<IBuildChainPattern, IBuildChainPattern> AddBuildChainPatternsTo;

  [DebuggerStepThrough]
  protected ArgumentTunerBase(Func<IBuildChainPattern, IBuildChainPattern> addBuildChainPatterns)
  ...
  public IArgumentTuner UseValue(T? value)
    => new ArgumentTuner(node => AddBuildChainPatternsTo(node).UseBuildAction(new Instance<T>(value), BuildStage.Create));
  ...
  public IArgumentTuner UseFactoryMethod(Func<T?> factoryMethod)
    => new ArgumentTuner(
        node => AddBuildChainPatternsTo(node).UseBuildAction(new CreateWithFactoryMethod<T>(_ => factoryMethod()), BuildStage.Create));
  ...
  public IArgumentTuner UseFactoryMethod<TR>(Func<TR?, object?> factoryMethod)
    => new ArgumentTuner(
        node => AddBuildChainPatternsTo(node).UseBuildAction(new CreateWithFactoryMethodBuildAction<TR, object>(factoryMethod), BuildStage.Create));
  ...
  public IArgumentTuner UseFactoryMethod<T1, T2>(Func<T1?, T2?, object?> factoryMethod)
    => new ArgumentTuner(
        node => AddBuildChainPatternsTo(node).UseBuildAction(new CreateWithFactoryMethodBuildAction<T1, T2, object>(factoryMethod), BuildStage.Create));
  ...
  public IArgumentTuner UseFactoryMethod<T1, T2, T3>(Func<T1?, T2?, T3?, object?> factoryMethod)
    => new ArgumentTuner(
        node => AddBuildChainPatternsTo(node).UseBuildAction(new CreateWithFactoryMethodBuildAction<T1, T2, T3, object>(factoryMethod), BuildStage.Create));
  ...
  public IArgumentTuner UseFactoryMethod<T1, T2, T3, T4>(Func<T1?, T2?, T3?, T4?, object?> factoryMethod)
    => new ArgumentTuner(
        node => AddBuildChainPatternsTo(node)
  ...
  Func<IBuildChainPattern, IBuildChainPattern> IInternal<Func<IBuildChainPattern, IBuildChainPattern>>.Member1 => AddBuildChainPatternsTo;
}