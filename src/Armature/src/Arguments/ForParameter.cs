...
public static class ForParameter
{
  ...
  public static MethodArgumentTuner OfType(Type type)
    => new(parentNode =>
             parentNode
              ...
              .AddNode(new IfFirstUnit(new IsMethodParameterWithType(new UnitPattern(type)), WeightOf.BuildContextPattern.IfFirstUnit + WeightOf.InjectionPoint.ByExactType),
  ...
  public static MethodArgumentTuner<T> OfType<T>()
    => new(parentNode =>
             parentNode
              .GetOrAddNode(new SkipWhileUnit(Static.Of<IsServiceUnit>(), 0))
              .AddNode(new IfFirstUnit(new IsMethodParameterWithType(new UnitPattern(typeof(T))), WeightOf.BuildContextPattern.IfFirstUnit + WeightOf.InjectionPoint.ByExactType),
  ...
  public static MethodArgumentTuner Named(string parameterName)
    => new(parentNode =>
             parentNode
              .GetOrAddNode(new SkipWhileUnit(Static.Of<IsServiceUnit>(), 0))
              .AddNode(new IfFirstUnit(new IsMethodParameterNamed(parameterName), WeightOf.BuildContextPattern.IfFirstUnit + WeightOf.InjectionPoint.ByName),
  ...
  public static MethodArgumentTuner WithInjectPoint(object? injectPointId)
    => new(parentNode =>
             parentNode
              .GetOrAddNode(new SkipWhileUnit(Static.Of<IsServiceUnit>(), 0))
              .AddNode(new IfFirstUnit(new IsParameterMarkedWithAttribute(injectPointId), WeightOf.BuildContextPattern.IfFirstUnit + WeightOf.InjectionPoint.ByInjectPointId),
