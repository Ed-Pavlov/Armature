...
public static class LogConst
{
  ...
  public static string ArmatureExceptionPostfix(string options = "") =>
    Environment.NewLine
  + $"See {nameof(System.Exception)}.{nameof(System.Exception.Data)}{options} for details or enable logging using {nameof(Log)}.{nameof(Log.Enable)} to investigate the error.";
