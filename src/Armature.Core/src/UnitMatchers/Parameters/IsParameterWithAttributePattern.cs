...
namespace Armature.Core
{
  ...
  public record IsParameterWithAttributePattern<T> : IsInjectPointByAttributePattern<T> where T : Attribute
  {
    [DebuggerStepThrough]
    public IsParameterWithAttributePattern(Predicate<T>? predicate) : base(predicate) { }
