...
/// <summary>
/// These methods are implemented as extensions instead of class members to be able to operate with 'null' BuildActionBag.
/// </summary>
public static class BuildActionBagExtension
{
  ...
  /// <summary>
  /// Returns the build action with the biggest matching weight for the build stage.
  /// </summary>
