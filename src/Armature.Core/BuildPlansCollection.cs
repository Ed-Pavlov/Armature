...
namespace Armature.Core
{
  ...
  public class BuildPlansCollection : IUnitSequenceMatcher, IEnumerable
  {
    ...
    /// </param>
    /// <param name="inputWeight">The weight of matching which used by children matchers to calculate a final weight of matching
    /// Not applicable to BuildPlansCollection in common case</param>
    /// <remarks>
