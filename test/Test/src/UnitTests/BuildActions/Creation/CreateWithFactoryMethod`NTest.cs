...
using Util_Void = Armature.Test.Util.Void;
using Void = Armature.Test.Util.Void;
...
public class CreateWithFactoryMethod_NTest
{
  ...
  public void N1_test()
  {
    ...
    var buildArguments = A.CallTo(() => buildSession.BuildUnit(default, true)).WhenBuildArgumentsOfType<int, Util_Void, Util_Void, Util_Void, Util_Void, Util_Void, Util_Void>();
