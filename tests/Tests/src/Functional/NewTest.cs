...
namespace Tests.Functional
{
  public class NewTest
  {
    ...
    public class A1: IA1{ public A1(IB1 b){}}
    public class B1: IB1{ public B1(IC1 c){throw new Exception();}}
    public class C1: IC1{ public C1(){}}
    
    public interface ISubject { }
    public class Subject : ISubject { public Subject(IA1 a){}}
